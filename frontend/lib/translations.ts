...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    home: {
      ...
      heroSubtitle:
        "Discover peer-reviewed tutorials, architecture breakdowns, and developer insights directly from experts.",
      showingResults: "Showing search results for:",
      clearSearch: "Clear Search",
      noArticlesTitle: "No Articles Found",
      noArticlesDesc:
        "We couldn't find any published articles matching your current filter criteria.",
      prev: "Prev",
      next: "Next",
    ...
    post: {
      ...
      articleNotFoundDesc: "The article you requested could not be retrieved.",
    ...
    createEditPost: {
      ...
      editSubtitle: "Update article details and category",
      titleLabel: "Title",
      ...
      changeImage: "Change Article Image",
      uploadImage: "Upload Article Image",
    ...
    admin: {
      ...
      postsManagement: "Posts & Articles",
  ...
  ar: {
    ...
    home: {
      ...
      heroSubtitle:
        "استكشف أحدث الشروحات، تحليلات السيستم، وخبرات المطورين من التقال في المجال.",
      showingResults: "نتائج البحث عن:",
      clearSearch: "امسح البحث",
      noArticlesTitle: "ملقيناش مقالات!",
      noArticlesDesc:
    ...
    admin: {
      ...
      postsManagement: "إدارة المقالات والبوستات",
      adminBadge: "أدمن النظام",
      searchUsers: "دور على يوزر...",
      searchPosts: "دور على مقال...",
      actions: "الإجراءات",
      role: "الصلاحية",
      admin: "أدمن",
      user: "مستخدم",
    ...
    auth: {
      ...
      createOneNow: "اعمل حساب جديد دلوقتي",
      alreadyHaveAccount: "عندك حساب بالفعل؟",
      backToLogin: "الرجوع لتسجيل الدخول",
      checkYourEmail: "افتح إيميلك",
      checkEmailDesc: "بعتنالك رابط الاسترجاع على إيميلك. اتأكد من خانة الـ Spam لو ملقيتوش.",
      canResendIn: "تقدر تبعت تاني بعد",
      resendEmail: "ابعت الإيميل تاني",
      enter6DigitCode: "اكتب كود الـ 6 أرقام",
      alreadyVerified: "أكدت حسابك خلاص؟",
    },
  },
};
